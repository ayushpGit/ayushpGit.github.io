(function($) {
    ...
    $('.SecurityTips-block, .menu-item.SecurityTips').on('click', function() {
        $('.content-blocks').removeClass('showx');
        $('.content-blocks.SecurityTips').addClass('showx');
        $('.menu-item').removeClass('active');
        $('.menu-item.SecurityTips').addClass('active');
    });
    ...
    //On Click Close SecurityTips Post And Project Details
